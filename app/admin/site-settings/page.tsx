      ...
      <div className="rounded-2xl border border-black/5 bg-white p-6 md:p-8 shadow-sm">
        <SiteSettingsForm
          initialData={{
            ...
            faviconPng16: settings?.faviconPng16 ?? "",
            faviconPng32: settings?.faviconPng32 ?? "",
            faviconAppleTouch: settings?.faviconAppleTouch ?? "",
            faviconAndroid192: settings?.faviconAndroid192 ?? "",
            faviconAndroid512: settings?.faviconAndroid512 ?? "",
            faviconIco: settings?.faviconIco ?? "",
